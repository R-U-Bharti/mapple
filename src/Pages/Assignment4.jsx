  ...
  useEffect(() => {
    mapplsClassObject.initialize(import.meta.env.VITE_MAP_KEY, loadObject, () => {
      ...
      newMap.on("load", () => {
        ...
        markerObject.setPopup("<div style='color: black;'><h4 style='font-weight: 600; border-bottom: 1px solid gray;'>Marker Info</h4><p>Some details about this marker.</p></div>")
        markerObject();
